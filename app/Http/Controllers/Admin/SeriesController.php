...
namespace Laravast\Http\Controllers\Admin;

use Laravast\Series;
use Illuminate\Http\Request;
use Laravast\Http\Controllers\Controller;
use Laravast\Http\Requests\CreateSeriesRequest;
use Laravast\Http\Requests\UpdateSeriesRequest;
