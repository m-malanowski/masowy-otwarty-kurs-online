    ...
    <div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="card card-shadowed p-50 w-400 mb-0" style="max-width: 100%">
          <h5 class="text-uppercase text-center">Zaloguj się</h5>
          <br><br>
          <form>
            ...
            <div class="form-group">
              <input type="hasło" class="form-control" placeholder="Password" v-model="password">
            </div>
            ...
            <div class="form-group flexbox py-10">
              <label class="custom-control custom-checkbox">
                ...
                <span class="custom-control-description">Zapamiętaj mnie</span>
              </label>
          ...
          <p class="text-center text-muted fs-13 mt-20">Nie masz jeszcze konta? <a href="page-register.html">Zarejestruj się</a></p>
        </div>
      </div>
    </div>
</template>
