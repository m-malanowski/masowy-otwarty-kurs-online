...
<html lang="en">
  ...
  <body class="mh-fullscreen bg-img center-vh p-20" style="background-image: url(assets/img/bg-girl.jpg);">
    ...
    <div class="card card-shadowed p-50 w-400 mb-0" style="max-width: 100%">
      <h5 class="text-uppercase text-center">Zarejestruj się</h5>
      <br><br>
      ...
      <form class="form-type-material" action="/register" method="post">
        ...
        <div class="form-group">
          <label class="custom-control custom-checkbox">
            ...
            <span class="custom-control-description">Potwierdzam wszystko <a class="text-primary" href="#">warunki</a></span>
          </label>
        </div>
